...
`r icon::fontawesome(style = "solid", "check")` Il existe un projet de spécifications officielles pour créer des documents paginés en CSS. Ce sont celles du [W3C](https://www.w3.org/TR/css-page-3/).

`r icon::fontawesome(style = "solid", "exclamation")` Sauf qu'elle ne sont pas encore implementées correctement dans les navigateurs.
...
+ Et une fonction pour permettre l'impression en PDF : `chrome_print` (utilise l'impression de Chrome ou de Edge).
